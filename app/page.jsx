    ...
    return (
        <main className="flex flex-col gap-8 sm:gap-16">
            <section className="flex flex-col items-start gap-3 sm:gap-4">
                ...
                {/* Peca */}
                <div data-widget="wait-time" data-token="eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9..gRnVp8eoepxSczcd4rIEhdTZhXKZbCdE7pm8szhkRxQ"></div>
                {/* zona dsk */}
                <div data-widget="wait-time" data-token="eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9..mCHdU-EIAkkHSVBV5tahKLaW2EJ-8-vAOKiLVnkOSh8"></div>
            </section>
            {!!ctx && (
